...
export default function ResetPassword() {
    ...
    const handleResetPassword = async () => {
        try {
            ...
            // 서버로 이메일 전송
            const response = await axios.post('http://localhost:8282/resetPassword', {
                email,
            }, {
        ...
        <div>
            ...
            <div className='main'>
                <form id="loginForm" method="get" action="/login">
                    <p id="restePassword-title"><strong>비밀번호 재설정</strong></p>
                    <p id="resetPassword-message">회원가입 시 등록한 이메일 주소를 입력해 주세요.</p><br />
