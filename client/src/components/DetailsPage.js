...
import DetailKakaoMapModal from "./DetailPageModal/DetailKakaoMapModal";
...
function DetailsPage() {
  ...
  const handleReservationPage = (id) => {
    const selectedId = id;
    window.location.href = `/Reservation?id=${selectedId}`;
  };
                            ...
                            <div id="room-reservation-text">
                              ...
                              <div>
                                <Button
                                  id="reservation-btn"
                                  onClick={() =>
                                    handleReservationPage(searchDetail)
                                  }
                                >
                                  객실 예약
                                </Button>
              ...
              <section id="detail-bottom-section">
                <div id="detail-review-map-secsion">
                  ...
                  <div id="detail-bottom-kakao-map">
                    <div
                      id="map"
                      style={{ width: 1200, height: 480, marginBottom: 10 }}
                    />
